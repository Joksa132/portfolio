  ...
  return (
    <>
      <div className="justify-center items-center flex fixed inset-0 z-50">
        <div className="rounded-lg relative flex flex-col bg-[#272727] p-2 w-80">
          ...
          <div className="relative p-2 flex flex-col">
            <Link href={project.gitHubLink.frontend} target="_blank">
              <span
                className="p-1 rounded-md text-lg text-white hover:bg-blue-500 flex items-center gap-1"
